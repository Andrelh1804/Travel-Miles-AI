      ...
      <div className="w-full max-w-md bg-white dark:bg-brand-900 rounded-2xl shadow-2xl p-8 animate-slide-up">
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gray-200 dark:border-brand-700" />
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-brand-900 text-gray-500">ou continue com</span>
          </div>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full py-3 border border-gray-300 dark:border-brand-700 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-brand-800 transition-colors text-gray-700 dark:text-white font-medium"
        >
